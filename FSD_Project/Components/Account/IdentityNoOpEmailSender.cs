...
namespace FSD_Project.Components.Account
{
    ...
    internal sealed class IdentityNoOpEmailSender : IEmailSender<FSD_ProjectUser>
    {
        private readonly IEmailSender emailSender = new NoOpEmailSender();

        public Task SendConfirmationLinkAsync(FSD_ProjectUser user, string email, string confirmationLink) =>
